"use strict";
  ...
  function normalizeRun(input) {
    ...
    return Object.assign({}, item, {
      ...
      sample_agent_protocol: item.sample_agent_protocol || configuration.sample_agent_protocol || null,
      candidate_concurrency: Number(item.candidate_concurrency || configuration.candidate_concurrency || 0),
